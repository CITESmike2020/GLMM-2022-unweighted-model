---
title: "Africa - Continental PIKE trend analysis"
author: "mk"
...
```{r}
load("report-africa-continental-fit_31-Mar-2022.Rdata") # created using save(all.fit, file="continental-fits.Rdata")
...
# Set BreakPoints 
BreakPoints <- data.frame(StartYear=c(2003, 2011), EndYear= c(2011, 2021))
...
gg <- gg + ggtitle("Africa:  Continental PIKE trend analysis") + ylab("PIKE") + ylim(0,1)
gg
